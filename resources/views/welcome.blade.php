    ...
    <div class="hero-inner">
        ...
        <div class="hero-left">
            <div class="hero-badge">
                ...
                BTRC Licensed ISP — LIVE NETWORK
            </div>

            <h1>
                Bangladesh's
                <span class="hero-gradient-text">Fastest Fiber</span>
                Internet
            </h1>
            <p class="hero-sub">Blazing-fast dedicated bandwidth with zero throttling. Powering homes and businesses across Bangladesh with enterprise-grade fiber.</p>
            <div class="hero-buttons">
                <a href="#packages" class="btn-hero-primary">🚀 View Packages</a>
                <a href="#contact" class="btn-hero-glass">📞 Free Consultation</a>
            </div>
            ...
            <div class="hero-speed-panel">
                <div class="speed-counter-box">
                    ...
                    <div class="speed-unit-text">Mbps</div>
                ...
                <div class="speed-mini-stats">
                    <div class="mini-stat">
                        ...
                        <div>
                            ...
                            <div class="mini-stat-lbl">Uptime SLA</div>
                        </div>
                    </div>
                    <div class="mini-stat">
                        <span class="mini-stat-icon">⚡</span>
                    ...
                    <div class="mini-stat">
                        ...
                        <div>
                            ...
                            <div class="mini-stat-lbl">Active Clients</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="hero-right">
            <div class="hero-visual-wrap">
                ...
                <div class="hero-float-badge hfb-1">
                    ...
                    <div>
                        <div class="hfb-val">10 Gbps</div>
                        <div class="hfb-lbl">Backbone Speed</div>
                    </div>
                </div>
                <div class="hero-float-badge hfb-2">
                    <span class="hfb-icon">🛡️</span>
                    <div>
                        <div class="hfb-val">BTRC</div>
                        <div class="hfb-lbl">Licensed &amp; Compliant</div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="section" id="packages">
    <div class="container">
        <div class="section-head reveal">
            <div class="section-chip">Internet Packages</div>
...
<footer>
    <div class="container">
        <div class="footer-grid">
            <div>
                <a href="#" class="footer-brand-logo"><img src="/images/logo.png" alt="SuperSpeed"><span>SuperSpeed Net</span></a>
...
async function loadMenus() {
    try {
        ...
        menus.forEach((menu, index) => {
            if (menu.is_button) {
                buttonHtml += `<a href="${menu.url || '#'}" class="btn-quick-pay" style="margin-left: 10px;">${menu.name} ⚡</a>`;
                return;
            }
